...
const navItemsByRole = {
  ...
  manager: [
    { label: "Branch Overview", path: "/manager", icon: LayoutDashboard },
...
const Sidebar = () => {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 flex h-screen w-64 flex-col bg-bank-sidebar text-white shadow-2xl shadow-blue-950/20">
      <div className="shrink-0 border-b border-white/15 px-5 py-5">
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-bank-accent text-sm font-bold text-white shadow-md ring-1 ring-white/20">
            AP
          </div>
