const ChartTooltip = ({ label, value, detail, percent, className = "" }) => (
  <div
    className={`pointer-events-none absolute z-20 min-w-44 rounded-lg border border-slate-200 bg-white px-3 py-2 text-left shadow-xl shadow-slate-900/10 ring-1 ring-slate-900/5 ${className}`}
  >
